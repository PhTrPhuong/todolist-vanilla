...
function renderTodos() {
    ...
    todos.forEach((todo) => {
        ...
        // deleteBtnNote: button handle delete action
        ...
        // editBtnNote: button handle edit action
        ...
        doneBtnNode.classList = "btn btn-done";
        ...
        // editFromNode: form cover & handle submit edited-label
...
/*---------*/
/*--- FUNCTIONS - handle delete todo item by id ---*/
function deleteTodo(id) {
    todos = todos.filter((todo) => todo.id !== id);
    renderTodos();
}

/*--- FUNCTIONS - handle toggle todo item's edit view ---*/
...
/*--- FUNCTIONS - handle update todo item's label ---*/
...
/*--- FUNCTIONS - handle update todo item's status ---*/
